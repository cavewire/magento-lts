    ...
    public function getElementHtml() {
        ...
        if ((string) $this->getValue()) {
            ...
            if ($ext === 'pdf') {
                ...
                $html   = "<embed class='small-image-preview' id=\"" . $this->getHtmlId() . '" src="' . $url . '#nameddest=self&page=1&view=FitH,0&zoom=80,0,0" type="application/pdf" height="' . $height . '" width="' . $width . '" />';
            } else {
                $html = '<a href="' . $url . '"'
